...
export function BlogCard({ data, key, darkmode }) {
  return (
    <article
      key={key}
      className={`shadow-lg rounded-lg p-6 mb-6 transition-transform transform hover:scale-105 ${
          ...
          <Link
            ...
            className={`flex items-center justify-center w-full border rounded mt-2 p-2 ${
              darkmode
                ...
                : "text-blue-500 hover:text-blue-700 border-blue-500 border:text-blue-700"
            }`}
          >
