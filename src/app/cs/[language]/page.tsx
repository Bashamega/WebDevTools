...
// interface CodingSnippetsTopicProps {
//   params: Params;
// }
// interface Article {
//   title: string;
...
// const CodingSnippetsTopic: React.FC<CodingSnippetsTopicProps> = ({ params }) => {
//   const [isDarkMode, setIsDarkMode] = useState(false);
//   const [notfound, setNotfound] = useState(false);
//   const [content, setContent] = useState<Article[] | undefined>(undefined);
//   const [filteredContent, setFilteredContent] = useState<Article[] | undefined>(undefined);
...
// export default CodingSnippetsTopic;
...
// const CodingSnippetsTopic: React.FC<CodingSnippetsTopicProps> = ({
//   params,
// }) => {
//   const [isDarkMode, setIsDarkMode] = useState(false);
//   const [notFound, setNotFound] = useState(false);
...
//   useEffect(() => {
//     const languageExists = languages.languages.some(
//       (language) =>
//         language.name.toLowerCase() === params.language.toLowerCase(),
//     );

//     if (languageExists) {
//       const loadContent = async () => {
//         try {
//           const contentData: Article[] = await import(
//             `@/db/codesnippets/posts/${params.language.toLowerCase()}/content.json`
//           );
...
//             toggleTheme={toggleTheme}
//           />
//           <div className="flex flex-col justify-center items-center h-full pt-12 px-5">
//             <section className="text-center p-10 rounded-lg">
//               <h1 className="text-4xl font-bold mb-4">
//                 {title(params.language)} Snippets
//               </h1>
...
//                         <BlogCard
//                           key={article.title} // Use a unique identifier
//                           data={article}
//                           darkmode={isDarkMode}
//                         />
//                       ))}
                ...
                {filteredContent.length > 0 ? (
                  <div className="container mx-auto p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      {filteredContent.map((article) => (
                        <BlogCard
                          key={article.title} // Ideally should be a unique ID or slug
                          data={article}
                          darkmode={isDarkMode}
                        />
                      ))}
