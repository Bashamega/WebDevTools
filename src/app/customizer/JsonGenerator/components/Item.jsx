    ...
    >
      ...
      <div>
        <input
          ...
          autoComplete="off"
          className="p-2 mb-2 mr-2 text-zinc-300 bg-gray-800 border border-gray-700 rounded-md focus:outline-hidden focus:border-gray-500 focus:bg-gray-800"
        />
        <select
          name="fieldType"
          value={field.fieldType}
          onChange={(e) => handleChange(field.id, e)}
          className="p-2 mr-3 text-zinc-300 bg-black border border-gray-700 rounded-md focus:outline-hidden focus:border-gray-500 focus:bg-gray-800 scrollbar"
        >
