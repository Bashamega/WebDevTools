...
`;
  ...
  interface WidthChangeEvent extends React.ChangeEvent<HTMLInputElement> {}

  const handleWidthChange = (event: WidthChangeEvent) => {
    setWidth(Number(event.target.value));
  };

  const handleCursorChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    setCursor(event.target.value);
  };

  interface HeightChangeEvent extends React.ChangeEvent<HTMLInputElement> {}

  const handleHeightChange = (event: HeightChangeEvent) => {
    setHeight(Number(event.target.value));
  };

  interface TextColorChangeEvent extends React.ChangeEvent<HTMLInputElement> {}

  const handleTextColorChange = (event: TextColorChangeEvent) => {
    setTextColor(event.target.value);
  };

  interface BorderRadiusChangeEvent
    extends React.ChangeEvent<HTMLInputElement> {}
  const handleBorderRadiusChange = (event: BorderRadiusChangeEvent) => {
    setBorderRadius(Number(event.target.value));
  };

  interface FontSizeChangeEvent extends React.ChangeEvent<HTMLInputElement> {}

  const handleFontSizeChange = (event: FontSizeChangeEvent) => {
    setFontSize(Number(event.target.value));
  };

  interface FontWeightChangeEvent
    extends React.ChangeEvent<HTMLSelectElement> {}

  const handleFontWeightChange = (event: FontWeightChangeEvent) => {
    setFontWeight(event.target.value);
  };

  interface FontFamilyChangeEvent
    extends React.ChangeEvent<HTMLSelectElement> {}
  const handleFontFamilyChange = (event: FontFamilyChangeEvent) => {
    setFontFamily(event.target.value);
  };

  interface BorderColorChangeEvent
    extends React.ChangeEvent<HTMLInputElement> {}
  const handleBorderColorChange = (event: BorderColorChangeEvent) => {
    setBorderColor(event.target.value);
  };

  interface BorderWidthChangeEvent
    extends React.ChangeEvent<HTMLInputElement> {}

  const handleBorderWidthChange = (event: BorderWidthChangeEvent) => {
    setBorderWidth(Number(event.target.value));
  };

  interface BorderStyleChangeEvent
    extends React.ChangeEvent<HTMLSelectElement> {}

  const handleBorderStyleChange = (event: BorderStyleChangeEvent) => {
