...
interface ColorsListProps {
  ...
  setColorsList: React.Dispatch<React.SetStateAction<ColorItem[]>>;
}
...
const getListStyle = (_isDraggingOver: boolean): ListStyle => ({
  display: "flex",
  padding: grid,
  paddingLeft: 10,
  paddingBottom: 45,
                      ...
                      <div className="absolute -bottom-13 left-1/2 transform -translate-x-1/2 flex justify-center items-center flex-col w-full">
                        <div className="w-full max-w-xs mx-auto">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const newItems = [...colorsList];
                              newItems[index].position = Number(e.target.value);
                              setColorsList(newItems);
                            }}
