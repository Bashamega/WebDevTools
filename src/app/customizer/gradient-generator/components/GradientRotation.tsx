...
interface GradientRotationProps {
  gradientRotation: { id: number; name: string; value: number };
  setGradientRotation: (rotation: {
    id: number;
    name: string;
    value: number;
  }) => void;
  gradientRotations: { id: number; name: string; value: number }[];
}

const GradientRotation: React.FC<GradientRotationProps> = ({
  gradientRotation,
  setGradientRotation,
  gradientRotations,
}) => {
