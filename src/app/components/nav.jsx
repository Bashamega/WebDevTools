...
//           className={`focus:outline-none text-[0.58rem] font-bold sm:font-bold items-center sm:text-sm flex md:text-sm flex-1 p-2 hover:${isDarkMode ? "bg-gray-700" : "bg-blue-700"} transition-all duration-700 rounded-lg`}
//         >
//           <FaTools fontSize={20} className="mr-2" />
//           Customizer tools
//           <svg className={`${isDropdownOpen ? "transform rotate-180" : ""} inline-block ml-[2px] w-[12px] h-4`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
//           </svg>
//         </button>

//         {isDropdownOpen && (
//           <div ref={dropdownRef} className={`absolute right-0 mt-2 py-2 ${isDarkMode ? "bg-gray-700 text-white" : "bg-white text-black"} rounded shadow-lg w-40`} style={{ zIndex: 100 }}>
//             <Link href="customizer/box-shadow-generator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Box Shadow Generator</Link>
//             <Link href="customizer/gradient-generator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>CSS Gradient Generator</Link>
//             <hr />
//             <Link href="customizer/button" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Buttons</Link>
//             <hr />
//             <Link href="customizer/LoremIpsumGenerator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Lorem Ipsum Generator</Link>
//             <Link href="customizer/CupcakeIpsumGenerator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Cupcake Ipsum Generator</Link>
//             <Link href="customizer/conversionCalculator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Conversion Calculator</Link>
//             <Link href="customizer/colorPicker" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Color picker</Link>
//             <Link href="customizer/JsonGenerator" className={`block px-4 py-2 hover:${isDarkMode ? "bg-gray-800 text-gray-500" : "bg-gray-200"}`}>Json Generator</Link>
//           </div>
//         )}
//       </div>
...
//           </p>
//         </Link>
//         <Link href="/MD" className={`text-[0.57rem] font-bold sm:text-sm p-2 hover:${isDarkMode ? "bg-gray-700" : "bg-blue-700"} transition-all duration-700 rounded-lg`}>
//           <p className="flex items-center justify-center gap-2">
//             <FaMarkdown fontSize={20} />
//             Markdown Editor
//           </p>
//         </Link>
//         <Link href="/about" className={`font-bold text-[0.6rem] sm:text-sm p-2 hover:${isDarkMode ? "bg-gray-700" : "bg-blue-700"} transition-all duration-700 rounded-lg flex items-center justify-center gap-2`}>
//           <FaInfo fontSize={15} />
//           About
//         </Link>
//         <Link href="/contribute" className={`font-bold text-[0.6rem] sm:text-sm p-2 hover:${isDarkMode ? "bg-gray-700" : "bg-blue-700"} transition-all duration-700 rounded-lg flex items-center justify-center gap-2`}>
...
//         </button>
//         <div className={`absolute w-full h-full flex items-center bg-blue-500 ${toggle ? "left-0 duration-300 ease-in" : "left-[100%] duration-300 ease-in"}`}>
//           <div className="flex flex-1 items-center text-white justify-center relative">
//             <ainkrrowBackIcon className="mr-4 absolute left-2 cursor-pointer" onClick={searchToggle} />
//             <Search />
//           </div>
//         </div>
//       </div>
