...
interface SiderProps {
  ...
  newFile: Dispatch<SetStateAction<CustomFile[]>>;

  activateFile: Dispatch<SetStateAction<CustomFile | null>>;
}
export default function Sider({ files, activateFile }: SiderProps) {
