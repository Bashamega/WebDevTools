...
// const ContributePage: React.FC<ContributePageProps> = () => {
...
//       cachedData &&
//       cacheTimestamp &&
//       now - Number(cacheTimestamp) < cacheExpiration
//     ) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center w-full">
        <section className="my-9 max-w-[40rem] p-6 bg-white border rounded-lg shadow dark:bg-gray-800">
          <h5 className="mb-2 text-3xl font-bold text-center">Contributors</h5>
              ...
              contributors
                ...
                .map((item) => (
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow dark:bg-gray-700">
                      <Image
                        src={item.avatar_url}
                        alt={item.login}
                        width={48}
                      ...
                      />
                      <span className="mt-2">{item.login}</span>
                    </div>
                  </Link>
                ))
            ) : (
        ...
        <section className="p-6 bg-white border rounded-lg shadow dark:bg-gray-800">
          <h5 className="text-3xl font-bold">Want to contribute?</h5>
          <p className="mt-2 text-base">
            Visit the GitHub repo and follow the guidelines to contribute!
          </p>
          <Link
            href="https://github.com/Bashamega/WebDevTools"
            className="mt-4 px-6 py-2 text-white bg-gray-800 rounded-lg dark:bg-gray-700"
          >
            <svg
              className="mr-3 w-7 h-7"
              viewBox="0 0 1024 1024"
